...
export default function Register() {
    ...
    const register = async () => {
        const res = await fetch('http://localhost:5000/users/register', {
            ...
            body: JSON.stringify({ email, password, firstName, famliyName }),
            credentials: "include"
        })
            ...
            <div className='login'>
                ...
                <Card sx={{ height: 400, width: 365}}>
                    <CardContent sx={{ margin:1}}>
                        ...
                        <TextField id="outlined-basic" label="Frist Name" variant="outlined" value={firstName} onChange={(e) => setFirstName(e.target.value)} />
